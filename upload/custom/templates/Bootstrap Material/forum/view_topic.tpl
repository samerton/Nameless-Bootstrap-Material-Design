		...
		<li><a target="_blank" class="dropdown-item" href="{$SHARE_FACEBOOK_URL}">{$SHARE_FACEBOOK}</a></li>
            ...
            {foreach from=$REPLIES item=reply name=arr}
			  ...
			  {if isset($reply.buttons.spam)}
                  <button class="btn btn-outline-danger btn-sm" rel="tooltip" data-trigger="hover"
              ...
              {/if}
                                    ...
                                    {if isset($reply.buttons.edit)}
                                        <a class="btn btn-outline-secondary btn-sm" data-toggle="tooltip" data-trigger="hover"
                                    ...
                                    {if isset($reply.buttons.report)}
                                        <button class="btn btn-outline-warning btn-sm" rel="tooltip"
                                    ...
                                    {if isset($reply.buttons.quote)}
                                        <button class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-trigger="hover"
