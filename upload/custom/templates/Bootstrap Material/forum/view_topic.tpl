	    ...
	    <div class="row">
		  ...
		  <div class="col-md-9">
			...
			<span class="pull-right">
			  ...
			  <button class="btn btn-outline-danger btn-sm" rel="tooltip" data-trigger="hover" data-original-title="{$reply.buttons.spam.TEXT}" data-toggle="modal" data-target="#spam{$reply.id}Modal"><i class="fa fa-flag fa-fw" aria-hidden="true"></i></button>
			  {/if}
			
			  {if isset($reply.buttons.edit)}
			  <a class="btn btn-outline-secondary btn-sm" data-toggle="tooltip" data-trigger="hover" data-original-title="{$reply.buttons.edit.TEXT}" href="{$reply.buttons.edit.URL}"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></a>
			  {/if}
			  
			  {if isset($reply.buttons.delete)}
			  <button class="btn btn-outline-danger btn-sm" rel="tooltip" data-trigger="hover" data-original-title="{$reply.buttons.delete.TEXT}" data-toggle="modal" data-target="#delete{$reply.id}Modal"><i class="fa fa-trash fa-fw" aria-hidden="true"></i></button>
			  {/if}
			  
			  {if isset($reply.buttons.report)}
			  <button class="btn btn-outline-warning btn-sm" rel="tooltip" data-trigger="hover" data-original-title="{$reply.buttons.report.TEXT}" data-toggle="modal" data-target="#report{$reply.id}Modal"><i class="fa fa-exclamation-triangle fa-fw" aria-hidden="true"></i></button>
			  {/if}
			  
			  {if isset($reply.buttons.quote)}
			  <button class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-trigger="hover" data-original-title="{$reply.buttons.quote.TEXT}" onclick="quote({$reply.id});"><i class="fa fa-quote-left fa-fw" aria-hidden="true"></i></button>
			  {/if}
			</span>
